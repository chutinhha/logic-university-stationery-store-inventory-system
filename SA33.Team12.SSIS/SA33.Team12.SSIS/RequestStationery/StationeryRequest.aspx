        ...
        <fieldset>
            ...
            <asp:Panel ID="Panel1" runat="server">
                <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateInsertButton="True"
                    ...
                    Width="466px" EnableViewState="False" OnModeChanging="DetailsView1_ModeChanging">
                    <Fields>
                        <asp:TemplateField HeaderText="Stationery">
                            ...
                            <InsertItemTemplate>
                                <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="StationeryItemDS0"
                                    DataTextField="Description" DataValueField="StationeryID" SelectedValue='<%# Bind("StationeryID") %>'>
                                </asp:DropDownList>
        ...
        <legend>Items Added</legend>
            <fieldset>
                ...
                <asp:GridView ID="RequestItemGridView" runat="server" AutoGenerateColumns="False"
                    AutoGenerateEditButton="True" EnableViewState="False" OnRowCancelingEdit="RequestItemGridView_RowCancelingEdit"
                    OnRowDeleting="RequestItemGridView_RowDeleting" OnRowEditing="RequestItemGridView_RowEditing"
                    OnRowUpdating="RequestItemGridView_RowUpdating" DataKeyNames="StationeryID">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="StationeryID">
                            <EditItemTemplate>
                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="StationeryDS" DataTextField="Description"
                        ...
                        <asp:TemplateField HeaderText="Quantity Needed">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("QuantityRequested") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>

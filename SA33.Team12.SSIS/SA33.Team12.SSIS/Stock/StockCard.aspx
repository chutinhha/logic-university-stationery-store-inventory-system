<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StockCard.aspx.cs" Inherits="SA33.Team12.SSIS.Stock.StockCard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DetailsView ID="dvStockCard" runat="server" Height="50px" Width="273px" 
        ...
        <Fields>
            ...
            <ItemTemplate> 
             <%# ((Location)Eval("Location")).Name %></ItemTemplate></asp:TemplateField>
